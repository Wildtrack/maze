	...
	AMaze.model.load('./mocks/maze3.json', function(loaded) {
		...
		canvas.Scene.new({
			...
			ready: function(stage) {
				...
				this.mazeRenderer = new AMaze.render.MazeRenderer({'bgcanvas':$('#bgcanvas')[0],'canvasEngine':canvas,'scene':this,'stage':stage,'maze':modelTest,'style':{'spritemap':spritemap}});
